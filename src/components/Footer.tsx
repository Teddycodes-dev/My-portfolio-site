    ...
    <footer className="border-t border-black/15 bg-[#efefef]">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10 md:flex-row md:items-end md:justify-between">
        <div className="flex flex-col gap-3">
          <p className="text-2xl tracking-tight">NK</p>
        ...
        <div className="flex flex-col gap-6 text-sm text-black/75 md:items-end">
          ...
          <a href="mailto:hello@nk.dev" className="underline underline-offset-4 transition hover:text-black">
            hello@nk.dev
          </a>
          <p className="text-xs text-black/55">© {new Date().getFullYear()} NK. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
